<template>
    <BaseHeader
      :title="'7185: BEFT Status Chang'"
      :is-four-button="true"
      :button1="'Accept'"
      :button2="'Exception'"
      :button3="'Refresh'"
      :button4="'Exit'"
      @onSubmitFromChildren="OnSubmit"
      @onViewFromChildren="OnDecline"
              ...
              <v-card outlined>
                <v-card-text>
                  ...
                  <v-row>
                    <v-col md="6" cols="12">
                      <v-autocomplete
                        v-model="objBEFTTransReg.EFFECTIVE_ENTRY_DT"
                        label="Effective Date :"
                        :items="ListOfLstxtOrgnEffDt"
                        item-title="label"
                        item-value="value"
                        :rules="rules.elementaryRules.required"
                        @update:modelValue="LsdEffectiveDateChange()"
                      >
                      </v-autocomplete>
                    </v-col>
                    <v-col md="6" cols="12">
                      <v-text-field
                        label="Branch :"
                        v-model="objBEFTTransReg.BRANCH_ID"
                        :rules="rules.elementaryRules.required"
                        @update:modelvalue="BranchUpdateControl()"
                      >
                      </v-text-field>
                    </v-col>
                  </v-row>
                  <v-row>
                    <v-col md="6" cols="12">
                      <v-autocomplete
                        v-model="objBEFTTransReg.TRANS_TYPE"
                        label="Transaction Type:"
                        :items="ListOfLsdTransType"
                        item-title="label"
                        item-value="value"
                    ...
                    <v-col md="6" cols="12">
                      <v-autocomplete
                        v-model="objBEFTTransReg.EFT_FILEID"
                        label="Function Type:"
                        :items="ListOfLsdFunctionType"
                        item-title="label"
                        item-value="value"
                  ...
                  <v-row>
                    <v-col md="6" cols="12">
                      <v-text-field
                        label="Account No :"
                        v-model="objBEFTTransReg.RECEIVER_ACC_NO"
                        v-on:keypress="[rules.isDecimal($event)]"
                        @update:modelValue="LstxtRcvrAccNo_TextChanged"
                      >
                  ...
                  <v-row>
                    <v-col md="6" cols="12">
                      <v-text-field
                        ...
                        :readonly="true"
                        v-model="obj_ListofTransSummary.vdrhoncnt"
                        :rules="[rules.required('true')]"
                      >
                      </v-text-field>
                    </v-col>
                    <v-col md="6" cols="12">
                      <v-text-field label="" :readonly="true" v-model="obj_ListofTransSummary.vdrhonamt" :rules="[rules.required('true')]">
                      </v-text-field>
                    </v-col>
                  </v-row>
                  <v-row>
                    <v-col md="6" cols="12">
                      <v-text-field
                        ...
                        :readonly="true"
                        v-model="obj_ListofTransSummary.vcrhoncn"
                        :rules="[rules.required('true')]"
                      >
                      </v-text-field>
                    </v-col>
                    <v-col md="6" cols="12">
                      <v-text-field label="" v-model="obj_ListofTransSummary.vcrhonamt" :readonly="true" :rules="[rules.required('true')]">
                      </v-text-field>
                    </v-col>
                  </v-row>
                  <v-row>
                    <v-col md="6" cols="12">
                      <v-text-field
                        ...
                        v-model="obj_ListofTransSummary.vtotcnt"
                        :readonly="true"
                        :rules="[rules.required('true')]"
                      >
                      </v-text-field>
                    ...
                    <v-col md="6" cols="12">
                      <v-text-field label="" v-model="obj_ListofTransSummary.vtotamt" :readonly="true" :rules="[rules.required('true')]">
                      </v-text-field>
                    </v-col>
                  </v-row>
                </v-card-text>
